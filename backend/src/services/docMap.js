...
export function mapScript(viewModel) {
  ...
  return `
    ...
    if (segs.length) {
      ...
      (function(){ const s = document.createElement('style'); s.textContent = '#map{background:#45597d}.leaflet-tile-pane{filter:invert(1) contrast(0.3) brightness(0.5) sepia(1) saturate(1.6) hue-rotate(180deg)}'; document.head.appendChild(s); })();
