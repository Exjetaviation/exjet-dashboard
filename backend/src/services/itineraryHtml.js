...
<style>
  * { box-sizing: border-box; }
  ...
  /* PDF pagination: let legs FLOW to fill the page (so a leg that doesn't fully fit
     doesn't leave a big blank gap), but never slice an individual block — route,
     crew, FBO card, passenger chip, weather card, aircraft hero, or the map. Keep a
     section header with the content that follows it. */
  .legroute, .crew, .fbo, .paxchip, .wx, .hero, #map { break-inside:avoid; page-break-inside:avoid; }
